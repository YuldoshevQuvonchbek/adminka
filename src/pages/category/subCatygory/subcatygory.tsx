...
import { useSearchSubCatygory } from "./service/query/useSearchCatygory";
...
const Subcatygory = () => {
  ...
  const { data, isLoading } = useGetSubCatygory("id", page);
  const [search, setSeach] = useState("");
  const { data: searchData } = useSearchSubCatygory(search);
